...
StubbyConfig = {
	["addinfo"] = {
		["Informant"] = "Informant|Displays detailed item information in tooltips, and can produce item reports by binding an information window to a keypress [5.1.3715] This AddOn is licensed under the GNU GPL, see GPL.txt for details.",
		["Enchantrix"] = "Enchantrix|Display information in item tooltips pertaining to the results of disenchanting said item.  [5.1.3715] This AddOn is licensed under the GNU GPL, see GPL.txt for details.",
	},
	["boots"] = {
		["informant"] = {
