...
ChatterDB = {
	["namespaces"] = {
		...
		["Highlight"] = {
			["profiles"] = {
				["Default"] = {
					["words"] = {
						["wildwyrm schlägt mit seinen"] = "Wildwyrm schlägt mit seinen",
					},
				},
			},
		},
			...
			["realm"] = {
				["Al'Akir"] = {
					["history"] = {
						...
						"/who veterans", -- [4]
						"/w Marduk Björn?", -- [5]
						"/w Marduk Marcel hier", -- [6]
						"/w Marduk alles ok bei dir?", -- [7]
						"/friend MArduk", -- [8]
						"/w Marduk autsch", -- [9]
						"/w Marduk Ich war heut zwar zu Hause, aber hab von der Arbeit gehört, dass du vermisst wurdest, und da du Freitag schon nicht zur Feier gekommen bist, macht man sich halt Sorgen", -- [10]
						"/w Marduk Eventuell solltest du mal noch ne Mail rumschicken, wie es um dich steht, damit die anderen bescheid wissen und entsprechend planen können", -- [11]
						"/w Marduk So woie ich das verstanden hab wusste heute keiner was mit dir ist", -- [12]
						"/w Marduk Ok, na dann noch erfolgreiches Raiden und gute Besserung", -- [13]
						"/w Marduk bis morgen", -- [14]
						"/who mort", -- [15]
						"/who veterans", -- [16]
					},
				},
				...
				["Magtheridon"] = {
					["history"] = {
						"/script DEFAULT_CHAT_FRAME:AddMessage(\"\\124cffa335ee\\124Hitem:50736:0:0:0:0:0:0:0:0\\124h[Heaven's Fall, Kryss of a Thousand Lies]\\124h\\124r\");", -- [1]
						"/leave 2", -- [2]
						"/script BLASC_DEBUG=1;", -- [3]
						"/script BLASC_DEBUG=1;", -- [4]
					},
				},
			},
		},
	...
	["profileKeys"] = {
		...
		["Erric - Magtheridon"] = "Default",
		["Opaca - Taerar"] = "Default",
		...
		["Jinjael - Der Rat von Dalaran"] = "Default",
		["Zinkun - Vek'nilash"] = "Default",
